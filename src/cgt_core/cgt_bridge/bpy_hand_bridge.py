...
class BpyHandBridge(bpy_bridge_interface.BpyInstanceProvider):
    ...
    def __init__(self, *args):
        ...
        src.cgt_core.cgt_bpy.cgt_collection.add_list_to_collection(self.col_name, self.left_hand, self.parent_col)
        src.cgt_core.cgt_bpy.cgt_collection.add_list_to_collection(self.col_name, self.right_hand, self.parent_col)
