...
from src.cgt_core.cgt_naming import POSE, COLLECTIONS
...
class BpyPoseBridge(bpy_bridge_interface.BpyInstanceProvider):
    ...
    def __init__(self, *args):
        ...
        src.cgt_core.cgt_bpy.cgt_collection.add_list_to_collection(self.col_name, self.pose, self.parent_col)
