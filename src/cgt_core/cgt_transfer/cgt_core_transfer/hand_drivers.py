...
class FingerDriverContainer(DriverContainer):
    ...
    # [-0.4363323129985824, 1.0471975511965976]
    # [-0.6108652381980153, 0.6981317007977318]
    [-0.4363323129985824, 0.6981317007977318]
    [-0.6981317007977318, 0.8726646259971648]
    print(*z_outputs, sep="\n")
    [-0.4363323129985824, 0.4363323129985824]
    # [0.4363323129985824, -0.6981317007977318]
    # [0.6108652381980153, -0.4363323129985824]
    [0.17453292519943295, -0.5235987755982988]
    [0.3490658503988659, -0.5235987755982988]

    # slope values for x-angles in radians
    x_map = [
        [[0.011, 0.631], [-0.6, 0.63]], [[0.011, 0.536], [-0.3, 0.54]], [[0.008, 1.035], [-0.15, 1.03]],
        [[0.105, 1.331], [-0.5, 1.33]], [[0.014, 1.858], [-0.2, 1.86]], [[0.341, 1.523], [-0.55, 1.52]],
        [[0.046, 1.326], [-0.5, 1.33]], [[0.331, 1.803], [-0.3, 1.81]], [[0.007, 1.911], [-0.15, 1.91]],
        [[0.012, 1.477], [-0.6, 1.48]], [[0.244, 1.674], [-0.3, 1.67]], [[0.021, 1.614], [-0.31, 1.61]],
        [[0.121, 1.322], [-0.8, 1.32]], [[0.213, 1.584], [-0.5, 1.58]], [[0.018, 1.937], [-0.31, 1.94]]]
